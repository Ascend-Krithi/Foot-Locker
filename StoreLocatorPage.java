...
public class StoreLocatorPage {
    ...
    public WebElement getSelectMyStoreElement() {
        ...
        throw new RuntimeException("Select My Store element not found using KB locator fallbacks");
    }

    public boolean isSelectMyStoreVisible() {
        try {
            return getSelectMyStoreElement().isDisplayed();
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public void enterSearchLocationAndSubmit(String location) {
        WebElement input = getSearchInput();
        input.clear();
        input.sendKeys(location + "\n");
    }
