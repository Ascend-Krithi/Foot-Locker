 ...
 * Description: Verify confirmation and store display after setting preferred store
 */
public class TS006_TC3232_ {
    ...
    public void testConfirmationAndStoreDisplay() {
        ...
        Assert.assertTrue(resultsPage.isConfirmationDisplayed(), "Confirmation not displayed after setting store");
    }
