 ...
 * Test Case ID: TC-001
 * Description: Search for stores by city and verify results
 */
public class TS004_TC001_ {
    ...
    public void testSearchByCity() {
        ...
        Assert.assertTrue(resultsPage.isStoreResultsDisplayed(), "Store results should be displayed for city");
    }
}
