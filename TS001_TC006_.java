 ...
 * Test Case ID: TC-006
 * Description: Launch app, Click Find a Store, Click Select My Store, Enter Boston MA, Click Search, Locate 375 Washington Street store, Click Set My Store, Check for confirmation indicator and verify store appears in header
 */
public class TS001_TC006_ {
    ...
    public void testConfirmationAndHeaderStore() {
        ...
        Assert.assertTrue(resultsPage.isConfirmationIndicatorPresent(card), "Confirmation indicator should be present");
        Assert.assertTrue(resultsPage.isStoreInHeader("375 Washington Street Boston MA 02108"), "Store should appear in header");
    }
