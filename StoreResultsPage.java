...
public class StoreResultsPage {
    ...
    public WebElement getSetMyStoreButtonForCard(WebElement card) {
        ...
        throw new RuntimeException("Set My Store button not found in card using KB locator fallbacks");
    }
}
