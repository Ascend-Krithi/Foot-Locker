...
Description: Search for Boston stores and verify specific store address is present
*/
public class TS004_TC001_2436 {
    ...
    public void testVerifySpecificStoreAddress() {
        ...
        Assert.assertNotNull(store, "Store with address 375 Washington Street, Boston, MA 02108 not found");
    }
