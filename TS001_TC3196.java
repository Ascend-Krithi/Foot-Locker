...
public class TS001_TC3196 extends BaseTest {

    @Test
    public void verifyBostonAddress() {
        ...
        for (WebElement store : stores) {
            if (store.getText().contains("375 Washington Street") && store.getText().contains("Boston")) {
                found = true;
                break;
            }
        }
        Assert.assertTrue(found, "Store at 375 Washington Street, Boston, MA 02108 should be present in results");
    }
}