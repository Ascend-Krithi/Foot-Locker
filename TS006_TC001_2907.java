 ...
 * Test Case ID: TC-001 (2907)
 * Description: Launch homepage -> Click Find a Store -> Click Select My Store -> Enter Boston, MA -> Click Search -> Locate store -> Click Set My Store -> Navigate to another page -> Verify store remains set
 */
