...
public class TS004_TC001_TestCaseSCRUM15408TS004TC001 extends BaseTest {
    @Test
    public void testStoreSearchBostonCity() {
        test = extent.createTest("TS004_TC001_TestCaseSCRUM15408TS004TC001");
        ...
        test.info("Step 4: Enter 'Boston, MA' in the Location textbox.");
        locatorPage.enterLocation("Boston, MA");
        Assert.assertEquals(locatorPage.getSearchInput().getAttribute("value"), "Boston, MA");
