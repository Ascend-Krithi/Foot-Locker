...
public class TC3231_SetPreferredStore extends BaseTest {
    @Test
    public void testSetPreferredStore() {
        ...
        Assert.assertTrue(results.isConfirmationIndicatorDisplayed(), "Confirmation indicator should be displayed after setting store");
    }
}
