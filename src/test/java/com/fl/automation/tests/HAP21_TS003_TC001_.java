 ...
 * Test Case ID: TC-001
 * Description: MyHP app - Launch app, tap Profile, tap Send Feedback, select feedback related dropdown
 ...
 */
public class HAP21_TS003_TC001_ {
    ...
    @Test
    public void testMobileAppFeedbackDropdownSelection() {
