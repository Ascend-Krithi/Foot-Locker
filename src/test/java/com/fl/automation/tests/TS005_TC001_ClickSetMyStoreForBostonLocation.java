...
Test Case ID: TC-001
Description: Click Set My Store for the Boston location at 375 Washington Street
*/
public class TS005_TC001_ClickSetMyStoreForBostonLocation {
    ...
    @Test
    public void testClickSetMyStoreForBostonLocation() {
