 ...
 * Test Case ID: TC-005
 * Description: Launch homepage, navigate to Store Locator, search Boston MA, locate specific store and click Set My Store
 */
public class TS001_TC005_ {
    ...
    public void testSetMyStoreForBostonLocation() {
        ...
        Assert.assertTrue(resultsPage.isConfirmationDisplayed(), "Store was not saved as preferred store");
    }
