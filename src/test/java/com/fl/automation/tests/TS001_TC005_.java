...
public class TS001_TC005_ extends BaseTest {
    @Test(description = "TC 3197: Launch, Find Store, Select My Store, enter 'Boston, MA', Search, find store '375 Washington Street, Boston, MA 02108', click Set My Store")
    public void testSetMyStoreBoston() {
        test = extent.createTest("TC 3197: Set My Store for Boston");
