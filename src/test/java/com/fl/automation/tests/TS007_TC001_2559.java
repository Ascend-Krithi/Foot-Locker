 ...
 * Test Case ID: TC-001 (2559)
 * Description: Set My Store and navigate to verify preferred store remains set
 */
public class TS007_TC001_2559 {
    ...
    public void testPreferredStoreRemainsSet() {
        ...
        Assert.assertTrue(driver.getPageSource().contains("Boston") || 
                         ...
                         "Selected store remains set as preferred store on the new page");
    }
