 ...
 * Description: Search with invalid location and verify error message or no results found
 */
public class TS003_TC002_2435 {
    ...
    public void testSearchWithInvalidLocation() {
        ...
        Assert.assertTrue(resultsPage.isEmptyResultsMessageDisplayed(), "Error message or 'No results found' not displayed");
    }
