 ...
 * Test Case ID: TC-001
 * Description: Launch homepage, set preferred store, navigate to another page and verify preferred store remains set
 */
public class TS007_TC001_ {
    ...
    public void testPreferredStorePersistsAcrossPages() {
        ...
        homePage.clickFindAStore();
        Assert.assertTrue(resultsPage.isConfirmationIndicatorDisplayed(), "Preferred store not persisted after navigation");
    }
