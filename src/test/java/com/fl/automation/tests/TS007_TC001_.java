...
public class TS007_TC001_ {
    ...
    public void testPreferredStorePersists() {
        ...
        homePage.open(ConfigReader.get("baseUrl"));
        // Check if preferred store is still displayed (simulate by checking store name is displayed)
        Assert.assertTrue(storeResultsPage.isStoreNameDisplayed("375 Washington Street, Boston, MA 02108"), "Preferred store not displayed after navigation");
    }
