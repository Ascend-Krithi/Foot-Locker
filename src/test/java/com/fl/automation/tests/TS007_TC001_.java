 ...
 * Test Case ID: TC-001
 * Description: Launch homepage, set Boston store, navigate to another page and verify preferred store persists
 */
public class TS007_TC001_ {
    ...
    public void testPreferredStorePersistsAcrossPages() {
        ...
        Assert.assertTrue(resultsPage.isConfirmationDisplayed(), "Preferred store not persisted on new page");
    }
