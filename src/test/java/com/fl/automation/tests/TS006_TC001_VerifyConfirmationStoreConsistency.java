...
Test Case ID: TC-001
Description: Verify confirmation indicator is displayed and store name appears consistently across website
*/
public class TS006_TC001_VerifyConfirmationStoreConsistency {
    ...
    @Test
    public void testVerifyConfirmationStoreConsistency() {
