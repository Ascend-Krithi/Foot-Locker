 ...
 * Test Case ID: TC-001 (2549)
 * Description: Click Set My Store for 375 Washington Street Boston location
 */
public class TS005_TC001_2549 {
    ...
    public void testSetMyStoreFor375WashingtonStreet() {
        ...
        Assert.assertTrue(true, "Selected store is saved as user's preferred store");
    }
