...
Test Case ID: TC-001
Description: Search for Boston, MA and verify store at 375 Washington Street is present in results
*/
public class TS004_TC001_SearchBostonMAVerify375WashingtonStreet {
    ...
    @Test
    public void testSearchBostonMAVerify375WashingtonStreet() {
