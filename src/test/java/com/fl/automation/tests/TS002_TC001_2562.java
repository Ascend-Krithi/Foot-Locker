...
/**
 * Acceptance Criteria ID: 2562
 * Test Scenario ID: SCRUM-15408 TS-002
 * Test Case ID: TC-001
 * Description: Ensure Find a Store popup is open, click Select My Store, verify Location textbox and Search for Stores button
 */
public class TS002_TC001_2562 {
    @BeforeMethod
    public void setUp() {
    ...
    @Test
    public void test_TS002_TC001_2562() {
