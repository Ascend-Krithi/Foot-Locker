...
Test Case ID: TC-001
Description: Verify confirmation indicator and store name appears consistently across website
*/
public class TS006_TC001_VerifyConfirmationIndicatorStoreAcrossWebsite {
    ...
    @Test
    public void testVerifyConfirmationIndicatorStoreAcrossWebsite() {
