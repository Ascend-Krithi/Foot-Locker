 ...
 * Test Case ID: TC-001
 * Description: Launch homepage, click Find a Store, and verify popup message and Select My Store link
 */
public class TS001_TC001_ {
    ...
    public void testFindAStorePopupAndSelectMyStoreLink() {
        ...
        Assert.assertTrue(locatorPage.getPopupMessage().contains("Choose a preferred store to make shopping easier"), "Popup message text mismatch");
