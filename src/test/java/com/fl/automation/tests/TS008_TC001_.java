...
public class TS008_TC001_ extends BaseTest {
    @Test(description = "TS-008 TC-001 - Set My Store and verify confirmation")
    public void testSetMyStoreAndVerifyConfirmation() {
        ...
        Assert.assertTrue(helper.setMyStoreForAddress("375 Washington Street, Boston, MA 02108"), "Should set My Store");
