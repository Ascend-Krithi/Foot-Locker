 ...
 * Test Case ID: TC-001 (2558)
 * Description: Set My Store and observe confirmation indicator and store name consistency
 */
public class TS006_TC001_2558 {
    ...
    @Test
    public void testConfirmationAndConsistency() {
        ...
        Assert.assertTrue(driver.getPageSource().contains("Boston") || 
                         ...
                         "Confirmation indicator is displayed and store name appears consistently across website");
    }
