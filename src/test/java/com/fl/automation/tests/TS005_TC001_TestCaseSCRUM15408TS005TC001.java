 ...
 * Test Case ID: TC-001
 * Description: Launch homepage, Click Find a Store, Click Select My Store, Enter 'Boston, MA', Click Search, Locate store '375 Washington Street, Boston, MA 02108', Click Set My Store
 */
