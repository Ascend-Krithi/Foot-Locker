...
/**
Acceptance Criteria ID: 2704
Test Scenario ID: SCRUM-15408 TS-001
Test Case ID: TC-008
Description: Launch website, navigate to store locator, search Boston MA, set store at '375 Washington Street, Boston, MA 02108', verify confirmation indicator displayed and store appears in header
*/
public class TS001_TC008_ {
    ...
    @Test
    public void testConfirmationIndicatorAndHeader() {
        ...
        // Optionally, verify store appears in header (if header updates, would require additional HomePage method)
