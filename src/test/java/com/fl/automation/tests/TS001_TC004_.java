...
public class TS001_TC004_ extends BaseTest {
    ...
    public void testScenario() {
        ...
        // Step 6: Check search results for store with address '375 Washington Street, Boston, MA 02108'
        Assert.assertNotNull(home.findStoreByAddress("375 Washington Street, Boston, MA 02108"), "Store with address '375 Washington Street, Boston, MA 02108' should be present in results");
    }
}
