 ...
 * Test Case ID: TC-004
 * Description: Launch homepage, navigate to Store Locator, search Boston MA and verify specific store address is visible
 */
public class TS001_TC004_ {
    ...
    public void testSpecificStoreAddressVisible() {
        ...
        Assert.assertTrue(resultsPage.isStoreAddressVisible("375 Washington Street, Boston, MA 02108"), 
                "Store with address 375 Washington Street, Boston, MA 02108 is not visible");
    }
