 ...
 * Test Case ID: TC-004
 * Description: Launch homepage, search for Boston MA stores and verify specific store address is visible
 */
public class TS001_TC004_ {
    ...
    public void testVerifySpecificStoreAddress() {
        ...
        Assert.assertTrue(resultsPage.isStoreAddressVisible("375 Washington Street, Boston, MA 02108"), 
            "Store with address 375 Washington Street, Boston, MA 02108 not visible in results");
    }
