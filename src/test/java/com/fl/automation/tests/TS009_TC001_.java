 ...
 * Test Case ID: TC-001
 * Description: Leave location empty, verify search button is disabled
 */
public class TS009_TC001_ {
    ...
    public void testSearchButtonDisabledWhenLocationEmpty() {
        ...
        Assert.assertFalse(storeResultsPage.isSearchButtonEnabled(), "Search button should be disabled when location is empty");
    }
