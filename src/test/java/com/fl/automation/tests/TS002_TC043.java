...
public class TS002_TC043 extends BaseTest {
    ...
    @Test(description = "TC4171: Store locator search Boston MA and verify results in popup")
    public void testStoreLocatorSearchBostonInPopup() throws InterruptedException {
        ...
        Assert.assertFalse(storeResults.isEmpty(), "Store search results should be displayed in popup");
    }
}