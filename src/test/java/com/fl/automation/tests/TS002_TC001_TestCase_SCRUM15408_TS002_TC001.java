 ...
 * Test Case ID: TC-001 (2013)
 * Description: Launch homepage, open Store Locator, enter 'Boston, MA' in Location textbox, and click Search.
 * Expected: Search results are displayed showing stores in or near Boston.
 */
