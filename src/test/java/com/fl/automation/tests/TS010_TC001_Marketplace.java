...
public class TS010_TC001_Marketplace extends BaseTest {
    @Test
    public void testMarketplaceLogout() {
        ...
        boolean redirectedToHome = wait.until(ExpectedConditions.urlContains("/home"));
        Assert.assertTrue(redirectedToHome, "User should be logged out and redirected to home");
    }
}