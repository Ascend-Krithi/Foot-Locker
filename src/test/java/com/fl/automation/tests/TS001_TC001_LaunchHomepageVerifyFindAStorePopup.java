...
Test Case ID: TC-001
Description: Launch the Foot Locker homepage in a browser and verify Find a Store popup
*/
public class TS001_TC001_LaunchHomepageVerifyFindAStorePopup {
    ...
    @Test
    public void testLaunchHomepageVerifyFindAStorePopup() {
