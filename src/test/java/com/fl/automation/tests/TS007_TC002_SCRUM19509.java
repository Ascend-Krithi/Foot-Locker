...
public class TS007_TC002_SCRUM19509 extends BaseTest {
    @Test
    public void testLoanApplicationInvalidValues() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("loanAmount"))).sendKeys("-5000");
        driver.findElement(By.id("income")).sendKeys("abc");
        driver.findElement(By.cssSelector("button[type='submit']")).click();
        ...
        Assert.assertTrue(errorMessagesDisplayed, "Error messages should be displayed for invalid fields");
    }
}