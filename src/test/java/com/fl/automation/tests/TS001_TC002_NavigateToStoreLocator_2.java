...
/**
 * Acceptance Criteria ID: 1942
 * Test Scenario ID: SCRUM-15408 TS-001
 * Test Case ID: TC-002
 * Description: Duplicate: Verify navigation to Store Locator page from Home Page
 */
public class TS001_TC002_NavigateToStoreLocator_2 {
    @BeforeMethod
    public void setUp() {
