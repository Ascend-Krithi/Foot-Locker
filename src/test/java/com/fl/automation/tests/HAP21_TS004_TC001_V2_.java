 ...
 * Description: MyHP app - Complete feedback submission with 4 star rating, Update and Features options
 ...
 */
public class HAP21_TS004_TC001_V2_ {
    ...
    @Test
    public void testMobileAppCompleteFeedbackSubmissionWithSpecificOptions() {
