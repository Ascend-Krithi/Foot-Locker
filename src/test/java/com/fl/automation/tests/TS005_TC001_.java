 ...
 * Test Case ID: TC-001
 * Description: Set '375 Washington Street, Boston, MA 02108' as preferred store, verify saved
 */
public class TS005_TC001_ {
    ...
    public void testSetPreferredStore() {
        ...
        Assert.assertTrue(results.isPreferredStoreSet("375 Washington Street, Boston, MA 02108"), "Preferred store not set");
    }
