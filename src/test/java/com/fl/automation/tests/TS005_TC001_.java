 ...
 * Test Case ID: TC-001
 * Description: Verify store address is displayed in results
 */
public class TS005_TC001_ {
    ...
    public void testStoreAddressDisplayed() {
        ...
        Assert.assertTrue(resultsPage.isStoreAddressDisplayed(), "Store address should be displayed in results");
    }
}
