 ...
 * Test Case ID: TC-001
 * Description: Launch website -> Click Find a Store -> Click Select My Store -> Enter 'Boston, MA' -> Click Search for Stores -> Locate store with address '375 Washington Street, Boston, MA 02108' -> Click Set My Store for Boston location
 */
