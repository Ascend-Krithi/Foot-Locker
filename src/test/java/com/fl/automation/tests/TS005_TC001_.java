 ...
 * Test Case ID: TC-001
 * Description: Launch website -> Click 'Find a Store' -> Click 'Select My Store' -> Enter 'Boston, MA' -> Click 'Search for Stores' -> Locate store '375 Washington Street, Boston, MA 02108' -> Click 'Set My Store'
 * Expected: Selected store saved as preferred store
 */
public class TS005_TC001_ {
    ...
    public void testSetMyStore() {
        ...
        // No explicit confirmation in this step
    }
