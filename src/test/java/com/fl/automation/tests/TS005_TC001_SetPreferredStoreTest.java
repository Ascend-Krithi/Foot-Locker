 ...
 * Test Case ID: TC-001
 * Description: Set preferred store and verify it is saved
 */
public class TS005_TC001_SetPreferredStoreTest {
    ...
    public void testSetPreferredStore() {
        ...
        Assert.assertTrue(storeResultsPage.isPreferredStorePersisted("375 Washington Street, Boston, MA 02108"), "Preferred store not saved");
    }
