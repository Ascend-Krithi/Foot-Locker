 ...
 * Test Case ID: TC-002
 * Description: Click 'Find a Store', click 'Select My Store', check for location textbox and search button
 */
public class TS001_TC002_ {
    ...
    @Test
    public void testSelectMyStoreAndLocationInput() {
        ...
        Assert.assertTrue(locator.isSearchButtonPresent(), "Search for Stores button is not present");
    }
}
