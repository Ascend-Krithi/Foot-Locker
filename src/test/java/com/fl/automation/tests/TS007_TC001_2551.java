 ...
 * Test Case ID: TC-001 (2551)
 * Description: Set My Store and verify it remains set after navigating to another page
 */
public class TS007_TC001_2551 {
    ...
    @Test
    public void testPreferredStoreRemainsAfterNavigation() {
        ...
        Assert.assertTrue(driver.getPageSource().contains("Boston") || 
                         ...
                         "Selected store remains set as preferred store and is displayed on the new page");
    }
