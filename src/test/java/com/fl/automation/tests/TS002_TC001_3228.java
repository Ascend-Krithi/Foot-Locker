 ...
 * Description: Click Find a Store, click Select My Store, verify Find a Store popup window with Location textbox and Search button
 */
public class TS002_TC001_3228 {
    ...
    @Test
    public void testSelectMyStorePopupWindow() {
