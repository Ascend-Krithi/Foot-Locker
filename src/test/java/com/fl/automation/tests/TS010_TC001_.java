...
public class TS010_TC001_ extends BaseTest {
    @Test(description = "TS-010 TC-001 - Verify confirmation indicator visible")
    public void testConfirmationIndicatorVisible() {
