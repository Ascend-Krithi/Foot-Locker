 ...
 * Test Case ID: TC-001
 * Description: Launch homepage, search for Boston, MA stores, set store and verify confirmation indicator is displayed
 */
public class TS006_TC001_ {
    ...
    public void testSetMyStoreAndVerifyConfirmation() {
        ...
        Assert.assertTrue(resultsPage.isConfirmationDisplayed(), "Confirmation indicator not displayed after setting store");
    }
