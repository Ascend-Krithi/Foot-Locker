 ...
 * Test Case ID: TC-001
 * Description: Launch homepage, set preferred store, verify confirmation indicator and check store appears consistently across website
 */
public class TS006_TC001_ {
    ...
    public void testSetMyStoreAndVerifyConfirmation() {
        ...
        Assert.assertTrue(resultsPage.isConfirmationIndicatorDisplayed(), "Confirmation indicator not displayed after setting store");
    }
