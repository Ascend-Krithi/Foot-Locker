 ...
 * Test Case ID: TC-001
 * Description: Launch homepage, click Find a Store, click Select My Store, enter 'Boston, MA', click Search for Stores, locate store '375 Washington Street, Boston, MA 02108', click Set My Store, navigate to another page, verify store remains set
 */
public class TS006_TC001_ {
    ...
    public void testStoreRemainsSetAfterNavigation() {
        ...
        storeLocatorPage.enterLocation("Boston, MA");
        storeLocatorPage.clickSearchForStores();
        Assert.assertTrue(storeResultsPage.isStoreSetConfirmationDisplayed("375 Washington Street, Boston, MA 02108"), "Store not set after navigation");
    }
