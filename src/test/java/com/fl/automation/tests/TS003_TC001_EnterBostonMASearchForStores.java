...
Test Case ID: TC-001
Description: Enter Boston, MA in Location textbox and click Search for Stores
*/
public class TS003_TC001_EnterBostonMASearchForStores {
    ...
    @Test
    public void testEnterBostonMASearchForStores() {
