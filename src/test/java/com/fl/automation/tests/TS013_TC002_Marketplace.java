...
public class TS013_TC002_Marketplace extends BaseTest {
    @Test
    public void testMarketplaceShareProjectSocialMedia() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Twitter')]"))).click();
        ...
        Assert.assertTrue(confirmationDisplayed, "Project should be shared successfully via social media");
    }
}