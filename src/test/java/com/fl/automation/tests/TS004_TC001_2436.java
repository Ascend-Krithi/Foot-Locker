 ...
 * Description: Search Boston stores and verify specific store address is present
 */
public class TS004_TC001_2436 {
    ...
    public void testVerifySpecificStoreAddress() {
        ...
        Assert.assertTrue(resultsPage.isStoreAddressVisible("375 Washington Street"), 
