...
public class TS002_TC003_SCRUM19509 extends BaseTest {
    @Test
    public void testApprovedInstallerVisibility() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(text(),'Installer approved')]")));
        ...
        driver.findElement(By.cssSelector("button[type='submit']")).click();
        boolean installerVisible = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(text(),'Green Installers Ltd')]"))).isDisplayed();
        Assert.assertTrue(installerVisible, "Approved installer should appear in search results");
    }
}