 ...
 * Test Case ID: TC-001
 * Description: Launch homepage, click Find a Store, click Select My Store, enter 'Boston, MA', click Search for Stores, locate store '375 Washington Street, Boston, MA 02108', click Set My Store button
 */
public class TS004_TC001_ {
    ...
    @Test
    public void testSetMyStoreButtonForStoreAddress() {
