 ...
 * Test Case ID: TC-001
 * Description: Search for 'Boston, MA', verify store with address '375 Washington Street, Boston, MA 02108' is present
 */
public class TS004_TC001_ {
    ...
    public void testStoreAddressPresent() {
        ...
        Assert.assertTrue(results.isStoreWithAddressPresent("375 Washington Street, Boston, MA 02108"), "Store address not found in results");
    }
