...
Test Case ID: TC-001
Description: Set preferred store and verify confirmation indicator is displayed and store name appears consistently across website
*/
public class TS006_TC001_VerifyStoreConsistencyAcrossWebsite {
    ...
    @Test
    public void testVerifyStoreConsistencyAcrossWebsite() {
