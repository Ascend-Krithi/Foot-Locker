 ...
 * Test Case ID: TC-001
 * Description: Launch homepage, click Find a Store, click Select My Store, enter Boston MA, click Search for Stores, verify results
 */
