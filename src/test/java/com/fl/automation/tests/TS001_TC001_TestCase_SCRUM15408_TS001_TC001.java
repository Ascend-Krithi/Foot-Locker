...
public class TS001_TC001_TestCase_SCRUM15408_TS001_TC001 {
    ...
    public void testFindAStorePopupAndSelectMyStore() {
        ...
        Assert.assertTrue(storeLocatorPage.isLocationTextboxDisplayed() || storeLocatorPage.isSearchForStoresButtonDisplayed(), "Select My Store link/button not displayed");
    }
