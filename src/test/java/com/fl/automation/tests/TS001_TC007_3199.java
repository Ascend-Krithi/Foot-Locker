 ...
 * Description: Launch homepage, set store, navigate to other page, verify store persists
 */
public class TS001_TC007_3199 {
    ...
    public void testStoreSelectionPersistence() {
        ...
        Assert.assertTrue(resultsPage.isConfirmationDisplayed(), "Store selection did not persist");
    }
