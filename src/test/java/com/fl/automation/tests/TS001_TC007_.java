...
public class TS001_TC007_ extends BaseTest {
    ...
    @Test
    public void testCase_SCRUM17166_TS001_TC007() {
        ...
        Assert.assertTrue(storeLocatorHelper.isStoreSetAsPreferred("Boston"), "Selected store does not persist as preferred store across navigation");
    }
}