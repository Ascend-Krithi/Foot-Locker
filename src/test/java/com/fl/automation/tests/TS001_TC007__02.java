...
public class TS001_TC007__02 extends BaseTest {
    @Test(description = "TS-001 TC-007 - Verify confirmation and consistency")
    public void testVerifyConfirmationAndConsistency() {
