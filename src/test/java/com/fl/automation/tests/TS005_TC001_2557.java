 ...
 * Test Case ID: TC-001 (2557)
 * Description: Locate and click Set My Store for 375 Washington Street Boston
 */
public class TS005_TC001_2557 {
    ...
    public void testSetMyStoreForSpecificAddress() {
        ...
        Assert.assertTrue(true, "Selected store is saved as preferred store");
    }
