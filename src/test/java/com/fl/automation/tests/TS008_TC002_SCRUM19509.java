...
public class TS008_TC002_SCRUM19509 extends BaseTest {
    @Test
    public void testInstallerMaximumCertifications() {
        ...
        boolean allCertificationsValidated = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".certifications-list"))).isDisplayed();
        Assert.assertTrue(allCertificationsValidated, "All certifications should be validated");
        ...
        Assert.assertTrue(installerOnboarded, "Installer should be onboarded with maximum certifications");
    }
}