 ...
 * Test Case ID: TC-001 (2550)
 * Description: Set My Store and verify confirmation indicator and consistency across website
 */
public class TS006_TC001_2550 {
    ...
    public void testConfirmationIndicatorAndConsistency() {
        ...
        Assert.assertTrue(driver.getPageSource().contains("Boston") || 
                         ...
                         "Confirmation indicator is displayed and selected store appears consistently across the website");
    }
