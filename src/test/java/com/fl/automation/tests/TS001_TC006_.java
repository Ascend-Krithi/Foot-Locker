...
public class TS001_TC006_ extends BaseTest {
    ...
    @Test
    public void verifyStoreConfirmationAndPersistence() {
        ...
        By confirmationIndicator = By.xpath("//*[contains(.,'Boston') or contains(.,'375 Washington Street')]");
        List<WebElement> confirmations = driver.findElements(confirmationIndicator);
        Assert.assertTrue(confirmations.size() > 0, "Confirmation indicator not displayed");
    }
}