 ...
 * Test Case ID: TC-006
 * Description: Launch homepage, navigate to Store Locator, search for Boston MA, set store at 375 Washington Street, and verify confirmation indicator and store appears in header
 */
public class TS001_TC006_ {
    ...
    public void testSetMyStoreAndVerifyConfirmation() {
        ...
        Assert.assertTrue(resultsPage.isConfirmationDisplayed() || resultsPage.isStoreInHeader("Boston"), 
                "Confirmation indicator or store in header not displayed");
    }
