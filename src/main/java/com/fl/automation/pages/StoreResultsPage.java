...
public class StoreResultsPage {
    ...
    public boolean areStoreResultsDisplayed() {
        try {
            List<WebElement> results = WaitUtils.waitForVisibilityOfAll(driver, storeResultCards);
    ...
    public boolean isStoreAddressVisible(String address) {
        try {
            List<WebElement> storeCards = WaitUtils.waitForVisibilityOfAll(driver, storeResultCards);
    ...
    public boolean isSearchButtonEnabled() {
        return BrowserUtils.isEnabled(driver, searchButton);
    }
}