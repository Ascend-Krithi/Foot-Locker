/**
 * TC_ID: 3244
 * Description: Validate search with empty string returns all stores or empty
 */
...
public class TS011_TC3244_ {
    ...
    public void testSearchWithEmptyString() {
        ...
        Assert.assertTrue(count >= 0, "Store card count should be >= 0 for empty search");
    }
