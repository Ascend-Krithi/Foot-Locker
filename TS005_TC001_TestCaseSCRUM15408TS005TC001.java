...
public class TS005_TC001_TestCaseSCRUM15408TS005TC001 extends BaseTest {
    @Test
    public void testStoreSearchExactAddress() {
        test = extent.createTest("TS005_TC001_TestCaseSCRUM15408TS005TC001");
        ...
        test.info("Step 6: Verify the store with address '375 Washington Street, Boston, MA 02108' is present and the address matches exactly.");
        Assert.assertNotNull(resultsPage.getStoreCardByAddress("375 Washington Street, Boston, MA 02108"));
    }
}